...
public class Nametags extends Module
{
    ...
    private void drawNametag(final Entity entityIn) {
        ...
        final String str = entityIn.func_70005_c_() + (this.health.getValue() ? (" " + Command.SECTIONSIGN() + "c" + Math.round(((EntityLivingBase)entityIn).func_110143_aJ() + ((entityIn instanceof EntityPlayer) ? ((EntityPlayer)entityIn).func_110139_bj() : 0.0f))) : "");
