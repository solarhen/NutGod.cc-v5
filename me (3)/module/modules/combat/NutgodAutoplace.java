...
@Info(name = "Autoplace", category = Category.COMBAT)
public class NutgodAutoplace extends Module
{
    ...
    public NutgodAutoplace() {
        ...
        this.packetListener = new Listener<PacketEvent.Send>(event -> {
            ...
            if (packet instanceof CPacketPlayer && NutgodAutoplace.isSpoofingAngles) {
                ((CPacketPlayer)packet).field_149476_e = (float)NutgodAutoplace.yaw;
                ((CPacketPlayer)packet).field_149473_f = (float)NutgodAutoplace.pitch;
            }
    ...
    public void onUpdate() {
        final EntityEnderCrystal crystal = (EntityEnderCrystal)NutgodAutoplace.mc.field_71441_e.field_72996_f.stream().filter(entity -> entity instanceof EntityEnderCrystal).map(entity -> entity).min(Comparator.comparing(c -> NutgodAutoplace.mc.field_71439_g.func_70032_d(c))).orElse(null);
        if (this.explode.getValue() && crystal != null && NutgodAutoplace.mc.field_71439_g.func_70032_d((Entity)crystal) <= this.range.getValue()) {
            if (this.antiWeakness.getValue() && NutgodAutoplace.mc.field_71439_g.func_70644_a(MobEffects.field_76437_t)) {
                if (!this.isAttacking) {
            ...
            this.lookAtPacket(crystal.field_70165_t, crystal.field_70163_u, crystal.field_70161_v, (EntityPlayer)NutgodAutoplace.mc.field_71439_g);
            NutgodAutoplace.mc.field_71442_b.func_78764_a((EntityPlayer)NutgodAutoplace.mc.field_71439_g, (Entity)crystal);
            NutgodAutoplace.mc.field_71439_g.func_184609_a(EnumHand.MAIN_HAND);
            ++this.breaks;
        ...
        int crystalSlot = (NutgodAutoplace.mc.field_71439_g.func_184614_ca().func_77973_b() == Items.field_185158_cP) ? NutgodAutoplace.mc.field_71439_g.field_71071_by.field_70461_c : -1;
        if (crystalSlot == -1) {
            for (int l = 0; l < 9; ++l) {
                if (NutgodAutoplace.mc.field_71439_g.field_71071_by.func_70301_a(l).func_77973_b() == Items.field_185158_cP) {
                    crystalSlot = l;
                    break;
                }
            }
        ...
        if (NutgodAutoplace.mc.field_71439_g.func_184592_cb().func_77973_b() == Items.field_185158_cP) {
            offhand = true;
        }
        ...
        if (this.players.getValue()) {
            entities.addAll((Collection<? extends Entity>)NutgodAutoplace.mc.field_71441_e.field_73010_i.stream().filter(entityPlayer -> !Friends.isFriend(entityPlayer.func_70005_c_())).collect(Collectors.toList()));
        }
        final boolean b2;
        entities.addAll((Collection<? extends Entity>)NutgodAutoplace.mc.field_71441_e.field_72996_f.stream().filter(entity -> {
        ...
        for (final Entity entity2 : entities) {
            if (entity2 != NutgodAutoplace.mc.field_71439_g) {
                ...
                for (final BlockPos blockPos : blocks) {
                    ...
                    final double self = calculateDamage(blockPos.field_177962_a + 0.5, blockPos.field_177960_b + 1, blockPos.field_177961_c + 0.5, (Entity)NutgodAutoplace.mc.field_71439_g);
                    if (self > d && d >= ((EntityLivingBase)entity2).func_110143_aJ()) {
                        continue;
                    }
                    if (self - 0.5 > NutgodAutoplace.mc.field_71439_g.func_110143_aJ()) {
                        continue;
                    }
                    damage = d;
                    q = blockPos;
        ...
        if (this.place.getValue()) {
            if (!offhand && NutgodAutoplace.mc.field_71439_g.field_71071_by.field_70461_c != crystalSlot) {
                if (this.autoSwitch.getValue()) {
                    NutgodAutoplace.mc.field_71439_g.field_71071_by.field_70461_c = crystalSlot;
                    if (this.rotate.getValue()) {
                        resetRotation();
                    }
                    this.switchCooldown = true;
            ...
            this.lookAtPacket(q.field_177962_a + 0.5, q.field_177960_b - 0.5, q.field_177961_c + 0.5, (EntityPlayer)NutgodAutoplace.mc.field_71439_g);
            EnumFacing f;
            if (this.raytrace.getValue()) {
                final RayTraceResult result = NutgodAutoplace.mc.field_71441_e.func_72933_a(new Vec3d(NutgodAutoplace.mc.field_71439_g.field_70165_t, NutgodAutoplace.mc.field_71439_g.field_70163_u + NutgodAutoplace.mc.field_71439_g.func_70047_e(), NutgodAutoplace.mc.field_71439_g.field_70161_v), new Vec3d(q.field_177962_a + 0.5, q.field_177960_b - 0.5, q.field_177961_c + 0.5));
            ...
            NutgodAutoplace.mc.field_71439_g.field_71174_a.func_147297_a((Packet)new CPacketPlayerTryUseItemOnBlock(q, f, offhand ? EnumHand.OFF_HAND : EnumHand.MAIN_HAND, 0.0f, 0.0f, 0.0f));
        }
        if (NutgodAutoplace.isSpoofingAngles) {
            if (NutgodAutoplace.togglePitch) {
                final EntityPlayerSP field_71439_g = NutgodAutoplace.mc.field_71439_g;
                field_71439_g.field_70125_A += (float)4.0E-4;
                NutgodAutoplace.togglePitch = false;
            }
            else {
                final EntityPlayerSP field_71439_g2 = NutgodAutoplace.mc.field_71439_g;
    ...
    public void onWorldRender(final RenderEvent event) {
        if (this.render != null) {
            ...
            if (this.renderEnt != null) {
                EntityUtil.getInterpolatedRenderPos(this.renderEnt, NutgodAutoplace.mc.func_184121_ak());
            }
        }
    }
    ...
    private boolean canPlaceCrystal(final BlockPos blockPos) {
        ...
        return (NutgodAutoplace.mc.field_71441_e.func_180495_p(blockPos).func_177230_c() == Blocks.field_150357_h || NutgodAutoplace.mc.field_71441_e.func_180495_p(blockPos).func_177230_c() == Blocks.field_150343_Z) && NutgodAutoplace.mc.field_71441_e.func_180495_p(boost).func_177230_c() == Blocks.field_150350_a && NutgodAutoplace.mc.field_71441_e.func_180495_p(boost2).func_177230_c() == Blocks.field_150350_a && NutgodAutoplace.mc.field_71441_e.func_72872_a((Class)Entity.class, new AxisAlignedBB(boost)).isEmpty();
    }
    
    public static BlockPos getPlayerPos() {
        return new BlockPos(Math.floor(NutgodAutoplace.mc.field_71439_g.field_70165_t), Math.floor(NutgodAutoplace.mc.field_71439_g.field_70163_u), Math.floor(NutgodAutoplace.mc.field_71439_g.field_70161_v));
    }
    ...
    public static float calculateDamage(final double posX, final double posY, final double posZ, final Entity entity) {
        ...
        if (entity instanceof EntityLivingBase) {
            finald = getBlastReduction((EntityLivingBase)entity, getDamageMultiplied(damage), new Explosion((World)NutgodAutoplace.mc.field_71441_e, (Entity)null, posX, posY, posZ, 6.0f, false, true));
        }
        return (float)finald;
    }
    ...
    private static float getDamageMultiplied(final float damage) {
        final int diff = NutgodAutoplace.mc.field_71441_e.func_175659_aa().func_151525_a();
    ...
    private static void setYawAndPitch(final float yaw1, final float pitch1) {
        NutgodAutoplace.yaw = yaw1;
        NutgodAutoplace.pitch = pitch1;
        NutgodAutoplace.isSpoofingAngles = true;
    }
    
    private static void resetRotation() {
        if (NutgodAutoplace.isSpoofingAngles) {
            NutgodAutoplace.yaw = NutgodAutoplace.mc.field_71439_g.field_70177_z;
            NutgodAutoplace.pitch = NutgodAutoplace.mc.field_71439_g.field_70125_A;
